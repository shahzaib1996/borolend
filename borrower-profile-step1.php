...
if(isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO `borrower_profile` (`uid`,`birth_date`,`pcity`,`pprovince`,`paddress`,`cnic`,`passport`) VALUES ('".$puid."','".$dob."','".$city."','".$province."','".$address."','".$cnic."','".$ppimg."')";
	$sqlup1 = "UPDATE borrower_individual SET up_check='1' , city='$city' WHERE id='".$uid."'";
	$sqlup2 = "UPDATE borrower_business SET up_check='1' , city='$city' WHERE id='".$uid."'";
	...
	echo "<script>alert('Please Upload Bank Statement Image')</script>";
}
...
<html>
	...
	<header class="header-4 header-2">	
		...
		<div class="container main-text">
			<div class="col-md-12">
				<h3>BORROWER PROFILE UPDATE</h3> <span class="location pull-right">You Are Here :  <a href="index.html">Home</a>  >  <span class="r-page">Courses</span></span>
			</div>
		</div>
