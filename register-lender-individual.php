...
<html>
	<head>
	   	<title>BOROLEND | Individual Lender Registeration</title>
	...
	<header class="header-4 header-2">	
		...
		<div class="container main-text">
			<div class="col-md-12">
				<h3>Register as a Lender</h3> <span class="location pull-right">You Are Here :  <a href="index.html">Home</a>  >  <span class="r-page">Register as a Lender</span></span>
			</div>
		</div>
	...
	<div class="l-r">
		...
		<img src="images/pencil-3.png" class="p2" alt="" />
			<div class="col-md-6 login">
				<h3>Register as a Lender</h3>
				<?php echo $error; ?>
				<form name="reLeIn" action="" method="post">
				...
				<label class="chkbox"><input type="checkbox" class="mychkbox" required name="cb1" onchange="this.setCustomValidity(validity.valueMissing ? 'Please indicate that you accept the Terms and Conditions' : '');" id="field_terms2" unchecked> &nbsp;&nbsp;I have read and agreed to the <a href="">TERMS AND CONDITIONS</a></label>
				<label class="chkbox"><input type="checkbox" class="mychkbox" required name="cb1" onchange="this.setCustomValidity(validity.valueMissing ? 'Please indicate that you accept the Terms and Conditions' : '');" id="field_terms3" unchecked> &nbsp;&nbsp;I authorize faircent.com to make any enquiries with any finance company or bank or register credit bureau regarding my credit history with them.</label>
