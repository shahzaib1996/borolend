...
$st = $con->query("SELECT * FROM apply_for_loan where a_check='1' ");
// if($st->num_rows > 0) {
...
<html>
<head>
	<title>BOROLEND | Loan Performance</title>
    ...
    <body>
    	...
    	<header class="header-4 header-2">	
    		...
    		<div class="container main-text">
    			<div class="col-md-12">
    				<h3>LOAN PERFORMANCE DETAILS</h3> <span class="location pull-right">You Are Here :  <a href="index.html">Home</a>  >  <span class="r-page">LOAN PERFORMANCE DETAILS</span></span>
    			</div>
    		</div>
    			...
    			<div class="row">
    				...
    				<div class="box">
    					<div class="box-header">
    						<h3 class="box-title" style="text-align:center;opacity:0.8;margin-bottom:20px;">The below table represents the Loan performance</h3>
    					</div>
    					<!-- /.box-header -->
    					<div class="box-body">
