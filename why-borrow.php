...
<html>
	...
	<header class="header-4 header-2">	
		...
		<div class="container main-text">
			<div class="col-md-12">
				<h3>Why Borrow on Borolend ?</h3> <span class="location pull-right">You Are Here :  <a href="index.html">Home</a>    <span class="r-page">Why Borrow on Borolend ?</span></span>
			</div>
		</div>
	...
	<div class="about">
		<div class="container">
			<div class="col-md-11 ab-main">
				<div class="txt-1">Why Borrow on Borolend ?</div>
				
				
				<p style="margin-left:6px;">Borolend provides easier and hassle-free process of getting loans at lower interest rate.  Borolend eliminates middle man and connects borrower directly to lender thus ensuring lower interest rate.  Moreover, Borrower has excess to different rates on which lenders are offering thus giving power to hands of Borrowers.  
				</p>

				<br>
				<div class="txt-1">Borrowing Criteria: </div>
				<br>
				...
				<ul style="list-style-type:circle">
					...
					<li>
						Have a minimum gross income of 6 LACS per annum.
					</li>
					<li>
