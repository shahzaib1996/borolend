...
if(isset($_POST['submit'])) {
	...
	$sql = "UPDATE lender_profile SET occupation='$occupation' , org_name='$org_name' , org_address='$org_add' , org_contact='$org_no' , avg_income='$avg_income' WHERE uid='".$puid."'";
	$sqlup1 = "UPDATE lender_individual SET up_check='2' WHERE id='".$uid."'";
	$sqlup2 = "UPDATE lender_org SET up_check='2' WHERE id='".$uid."'";
