...
//   $msg = $_POST['message'];
//   $headers = "From: noreply@borolend.com";
//     // $headers2 = "From:" . $to;
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../tables/lender-registration.php"><i class="fa fa-circle-o"></i> Lenders</a></li>
            <li><a href="../tables/borrower-registration.php"><i class="fa fa-circle-o"></i> Borrowers</a></li>
          </ul>
        </li>
        <li>
          <a href="../tables/loan-requests.php">
            <i class="fa fa-calendar"></i> <span>Loan Request</span>
          </a>
        </li>
        <li>
          <a href="../tables/lend-request.php">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        E-Mail
        <small>Easy to Send noreply emails</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group"> 
                <input class="form-control" type="email" placeholder="To:" name="from" required>
              </div>
              <div class="form-group">
