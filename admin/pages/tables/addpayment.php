        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Loan Request Add payment</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                while($row2 = $result2->fetch_assoc()) {
                  ...
                  <td>".$row2["borrow_amount"]."</td>
                  <td>".$row2["rate"]."</td>
                  <td>".$row2["time"]."</td>
                  <td>".$row2["payment"]."</td>
                  <td>".$row2["paid"]."</td>
                  <td>".$row2["pending"]."</td>
                  <td><a href='admin-ap.php?id=".$row2['uid']."&type=".$row2['type']."&loanapp=".$row2['aid']."' class='btn btn-success'>Add Payment</a></td>
                </tr>";
                }
                } 
