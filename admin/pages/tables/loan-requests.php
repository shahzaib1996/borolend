...
$result1 = $con->query("SELECT * FROM apply_for_loan where a_check='0'");
$result2 = $con->query("SELECT * FROM apply_for_loan where a_check='1'");
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                while($row1 = $result1->fetch_assoc()) {
                  ...
                  <td>".$row1["payment"]."</td>
                  <td>".$row1["purpose"]."</td>
                  <td><a href='admin-lend-info.php?id=".$row1['uid']."&type=".$row1['type']."&loanapp=".$row1['aid']."' class='btn btn-success'>View Profile</a></td>
                </tr>";
                }
                } 
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                while($row2 = $result2->fetch_assoc()) {
                  ...
                  <td>Rs. ".$row2["borrow_amount"]."</td>
                  <td>".$row2["rate"]." %</td>
                  <td>".$row2["time"]." M</td>
                  <td>".$row2["payment"]."</td>
                  <td>".$row2["purpose"]."</td>
                  <td><a href='admin-lend-info.php?id=".$row2['uid']."&type=".$row2['type']."&loanapp=".$row2['aid']."' class='btn btn-success'>View Profile</a></td>
                </tr>";
                }
                } 
