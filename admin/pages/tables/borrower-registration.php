...
$result1 = $con->query("SELECT * FROM borrower_individual where verify_status='0'");
$result2 = $con->query("SELECT * FROM borrower_individual where verify_status='1'");
...
<head>
  ...
  <title>Borower Registrations</title>
