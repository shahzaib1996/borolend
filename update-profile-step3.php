...
if(isset($_SESSION['uid'])) {
	...
	if($type == 'li') {
		...
		elseif($up_check == '2') {
			...
			?>
			<script type="text/javascript">
			window.location.href = 'lender-account.php';
			</script>
			<?php
		}
...
if(isset($_POST['submit'])) {
	...
	$branch=$_POST['branch'];
	$city=$_POST['city'];
	$sql = "UPDATE lender_profile SET title_account='$toa' , account_number='$a_no' , bank='$bank' , branch='$branch' , bcity='$city' WHERE uid='".$puid."'";
	$sqlup1 = "UPDATE lender_individual SET up_check='3' WHERE id='".$uid."'";
	$sqlup2 = "UPDATE lender_org SET up_check='3' WHERE id='".$uid."'";
