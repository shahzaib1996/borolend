...
if(isset($_POST['submit'])) {
	...
	$sql = "UPDATE borrower_profile SET occupation='$occupation' , org_name='$org_name' , org_address='$org_add' , org_contact='$org_no' , avg_income='$avg_income' , loan_purpose='$loan_purpose' WHERE uid='".$puid."'";
	$sqlup1 = "UPDATE borrower_individual SET up_check='2' WHERE id='".$uid."'";
	$sqlup2 = "UPDATE borrower_business SET up_check='2' WHERE id='".$uid."'";
	...
	<div class="row">
		<div class="up-wrap col-md-12">
			<div class="upinner">
				...
				<input type="text" class="form-control upt" placeholder="Enter Occupation..." name="occupation" required>
				<label>Institution/Organization Name</label>
				<input type="text" class="form-control upt" placeholder="Enter Institution Name..." name="org_name" required>
				<label>Institution/Organization Address</label>
				<input type="text" class="form-control upt" placeholder="Enter Institution Name..." name="org_add" required>
				<label>Institution/Organization Contact Number</label>
				<input type="text" class="form-control upt" placeholder="Enter Institution Contact No..." name="org_no" required>
				<label>Average income per month</label>
				<input type="text" class="form-control upt" placeholder="Enter Average Income..." name="avg_income" required>
				<label>Purpose of Loan</label>
				<input type="text" class="form-control upt" placeholder="Purpose of Loan..." name="loan_purpose" required>
