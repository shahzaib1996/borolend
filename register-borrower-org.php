...
$error = '<div style="position:absolute;font-size:12px;padding:3px 10px;" class="alert alert-danger" role="alert"> <b>ERROR</b> Email address already in use...</div>';
  		...
  		$sql = "INSERT INTO `borrower_business` (`fname`,`lname`,`email`,`password`,`mobile`) VALUES ('".$fname."','".$lname."','".$email."','".$pass."','".$mobile."')";
...
<html>
	<head>
	   	<title>BOROLEND | Business Borrower Registeration</title>
	...
	<div class="l-r">
		...
		<img src="images/pencil-3.png" class="p2" alt="" />
			<div class="col-md-6 login">
				...
				<?php echo $error; ?>
				<form name="reBoOrg" action="" onsubmit="" method="post">
